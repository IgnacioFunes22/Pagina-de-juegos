...
const tagRouts = require("./routes/etiquetas");
const userRouts = require("./routes/usuario");
const commentsRouts = require("./routes/comentarios");
...
// Rutas
app.use("/games/api", itemsRouts);
app.use("/etiquetas/api", tagRouts);
app.use("/api/usuario", userRouts);
app.use("/comentarios/api", commentsRouts);
